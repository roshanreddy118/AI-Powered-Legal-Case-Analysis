          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-black/60 backdrop-blur-sm border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 text-white placeholder-gray-300 transition-all duration-300 hover:border-white/40"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                required
                className="w-full px-4 py-3 bg-black/60 backdrop-blur-sm border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 text-white transition-all duration-300 hover:border-white/40"
              >
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full px-4 py-3 bg-black/60 backdrop-blur-sm border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/50 text-white placeholder-gray-300 transition-all duration-300 hover:border-white/40 resize-none"
